...
An end-to-end automated AI/ML internship system. JobApply discovers job listings, scores and filters them, enriches details via Jobright, and generates tailored resumes and cover letters with an LLM. It also runs **recruiter outreach** — drafting personalized cold emails and referral asks, sending them via Gmail, and tracking follow-ups — and walks you through an interactive apply session with a headed browser, pausing for your confirmation before any form is submitted.
...
- **Recruiter outreach** — manage recruiters, generate personalized cold emails or referral asks (LLM), discover likely email addresses, send via Gmail SMTP, and track replies + 7-day follow-ups — all from an Outreach dashboard tab
